  ...
  self.addEventListener('message', function (ev) {
    ...
    switch (data.cmd) {
      case 'init':
        ...
        break;
      case 'demux':
        self.demuxer.append(new Uint8Array(data.data), data.audioCodec, data.videoCodec, data.timeOffset, data.cc, data.level, data.sn, data.duration,data.accurateTimeOffset);
        break;
      case 'complete':
